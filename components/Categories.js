...
const cats = [
  ...
  },
  {
    name: "Casual",
    slug: "casual",
    img: "https://images.unsplash.com/photo-1551163943-3f6a855d1153?auto=format&fit=crop&w=700&q=80",
  },
  {
    name: "Party Wear",
    slug: "party-wear",
    ...
    <section id="categories" className="py-24 md:py-32 bg-cream">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-wrap items-end justify-between mb-12">
          ...
          <Link
            href="/shop"
            className="text-sm tracking-widest uppercase text-ink hover:text-rose transition-colors"
          >
            View all →
          </Link>
        </div>
